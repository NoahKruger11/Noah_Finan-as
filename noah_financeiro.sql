...
--
-- Banco de dados: `noah_financeiro`
--
CREATE DATABASE IF NOT EXISTS `noah_financeiro` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `noah_financeiro`;
...
(1, 'Noah Kruger Nunes Lopes', '023.456.789-10'),
